...
import { getAppController, Env } from './core-utils';
...
export class MCPManager {
  ...
  async initialize(env: Env) {
    ...
    const serverConfigs = await controller.listMCPServers();
  ...
  async getToolDefinitions(env: Env) {
  ...
  async executeTool(toolName: string, args: Record<string, unknown>, env: Env): Promise<string> {
    await this.initialize(env);

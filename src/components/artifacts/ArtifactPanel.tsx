...
import { X, Code, Eye, Terminal, GalleryHorizontal, Download, Eraser } from 'lucide-react';
    ...
    <div className="h-full flex flex-col bg-zinc-900/50">
      ...
      <div className="flex-1 min-h-0">
        <Tabs defaultValue={defaultTab} className="h-full flex flex-col">
          <TabsList className="grid w-full grid-cols-4 bg-zinc-950 rounded-none border-b border-white/10">
          ...
          <TabsContent value="code" className="flex-1 min-h-0">
            <ScrollArea className="h-full">
              <SyntaxHighlighter language={artifact.language || 'plaintext'} style={vscDarkPlus} customStyle={{ background: 'transparent', margin: 0, height: '100%' }} codeTagProps={{ style: { fontFamily: 'inherit' } }} showLineNumbers>
                {artifact.content}
              </SyntaxHighlighter>
            </ScrollArea>
          </TabsContent>
